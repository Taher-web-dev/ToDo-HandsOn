    ...
    class TasksController < ApplicationController
      ...
      def update
        ...
        if @task.update(params_update)
          ...
          render json: { status: 'Error', message: 'Something went wrong!', data: @task.errors },
      ...
      def create
        ...
        if @task.save
          ...
          render json: { status: 'Error', message: "Something went wrong, Task doesn't created!", data: @task },
                 status: :unprocessable_entity
        end
      end
